...
use summon_compiler::{assemble, compile_linked_module, resolve_path, ResolvedPath};
use summon_vm::{circuit_vm::CircuitVM, vs_value::Val, Bytecode, DecoderMaker, ValTrait};
...
fn main() {
  ...
  for file_path in files {
    ...
    let compile_result = compile_linked_module(resolved_path, |path| {
